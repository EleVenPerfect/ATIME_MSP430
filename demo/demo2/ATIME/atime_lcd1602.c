...
#ifndef _ATIME_MSP430_LCD1602_C_ 
#define _ATIME_MSP430_LCD1602_C_


/*************************************
库全局变量组
*************************************/
#define LCD1602_DATA       5     //定义lcd1602的8位数据口

#define LCD1602_RS_PORT    4     //将RS位定义;端口号
#define LCD1602_RS_BIT     0     //将RS位定义;端口位

#define LCD1602_RW_PORT    4     //将RW位定义;端口号
#define LCD1602_RW_BIT     1     //将RW位定义;端口位

#define LCD1602_EN_PORT    4     //将EN位定义;端口号
#define LCD1602_EN_BIT     2     //将EN位定义;端口位
